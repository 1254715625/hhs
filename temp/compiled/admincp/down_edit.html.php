...
<body>
<div class="ur_here">首页 &raquo; 任务管理 &raquo; 修改下载信息</div>
<div class="container">
	<div class="subnav">
    ...
    <table width="100%" id="editTb">
      ...
      <tr>
        ...
        <td>
        	<input name="title" type="text" value="<?php echo $this->_var['info']['title']; ?>"/>
        	<input type="hidden" name="id" value="<?php echo $this->_var['info']['id']; ?>"/>
        </td>
      </tr>
      <tr>
        <td class="left">文件地址</td>   
        <td><input name="file_path" type="text" value="<?php echo $this->_var['info']['file_path']; ?>" /></td>
      </tr>
      <tr>
        <td class="left">文件描述</td>
        <td><textarea name="intro"><?php echo $this->_var['info']['intro']; ?></textarea></td>
      </tr>
	  <tr>
        ...
        <td>
			...
			<span style="margin-left:5px;">(请上传120*100大小图片)</span>
        </td>
      </tr>
	  ...
	  <tr>
        ...
        <td>
        	<p class="p-m">
        	    <img src="<?php echo $this->_var['info']['img']; ?>" style="width:120px;height:100px;">
            </p>
        </td>
      </tr>
	  <?php } ?>
