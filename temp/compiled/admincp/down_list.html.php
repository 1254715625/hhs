...
<body>
<div class="ur_here">首页 &raquo; 任务管理 &raquo; 下载管理</div>
<div class="container">
	<div class="subnav">
		<a href="?act=info">新增下载</a>
	</div>
    ...
    <table width="100%" id="listTb">
      ...
      <tr>
        ...
        <td><?php echo $this->_var['item']['intro']; ?></td>
        <td><?php echo $this->_var['item']['views']; ?></td>
        <td><a href="?act=edit&id=<?php echo $this->_var['item']['id']; ?>">修改</a>|<a href="?dropid=<?php echo $this->_var['item']['id']; ?>" onclick="return confirm('您确定要删除此信息吗？')">删除</a></td>
      </tr>
	  <?php } ?>
    </table>
    </form>
