...
<body>
<div class="ur_here">首页 &raquo; 系统设置 &raquo;  添加管理员</div>
<div class="container">
	<div class="subnav">
    ...
    <form id="form1" name="form1" method="post" action="" onsubmit="return checkForm(this);">
	    <input type="hidden" name="admin_id" value="<?php echo $this->_var['data']['admin_id']; ?>" />
	    <table width="100%" id="editTb">
		  ...
		  <tr>
			...
			<td>
				<select name="role">
					<option value="1" <?php if($this->_var['data']['role'] == 1){ ?> selected <?php } ?>>超级管理员</option>
					<option value="2" <?php if($this->_var['data']['role'] == 2){ ?> selected <?php } ?>>普通管理员</option>
				</select>
			</td>
	      </tr>
		  <tr>
		  ...
		  <tr>
	        ...
	        <td>
	        	<label>
	        		<input name="is_ok" type="radio" value="1" <?php if($this->_var['data']['is_ok'] == 1){ ?>checked<?php } ?>/>&nbsp;屏蔽
	        	</label>
	        	<label>
