...
<body>
<div class="ur_here">首页 &raquo; 网站设置 &raquo; 短信设置</div>
<div class="container">
    <form id="form1" name="form1" method="post" action="" onsubmit="return checkForm(this);">
    <table width="100%" id="editTb">
      <tr>
        <th colspan="2">短信设置</th>
      </tr>
      ...
      <tr>
        ...
        <td><input name="param[<?php echo $this->_var['key']; ?>]" type="text" value="<?php echo $this->_var['info'][$this->_var['key']]; ?>" size="45" /></td>
      </tr>
	  <?php } ?>
      <tr>
