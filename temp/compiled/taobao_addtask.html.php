...
<form id="all-data" enctype="multipart/form-data" method="post" action="taobao.php?mod=addTask" onsubmit="return check();">
<div class="fabu_box2">
...
<li class="ligoods">
	...
	<div class="vb">
	<input class="txt txtprice" id="goods_price" type="text"  name="task_other[shopAll][1][txtprice]" style="width:45px;" onblur='change()' value="<?php echo $this->_var['temval']['task_other']['shopAll']['1']['txtprice']; ?>">
	  元
	</div>
	<div class="exp">
...
<li class="ligoods">
	...
	<div class="name">商品担保价格：</div>
	<div class="vb">
	<input class="txt txtprice" id="goods_prices" type="text" name="task_other[shopAll][2][txtprice]" style="width:45px;" onblur='change()' value="<?php echo $this->_var['temval']['task_other']['shopAll']['2']['txtprice']; ?>">
	  元
	</div>
	<div class="ex">
		...
		<li><div class="name">追加悬赏刷点：</div>
			...
			<li>
				...
				<div class="value">
					...
					<label id="address" address="<?php echo $this->_var['accs']['0']['send_address']; ?>"><input type="radio" id="isProvince" name="Express" value="<?php echo $this->_var['accs']['0']['send_address']; ?>" cid="0" <?php if($this->_var['temval']['Express'] == 2){ ?>checked="checked"<?php } ?>> 
	                    同省[<?php echo $this->_var['accs']['0']['send_address']; ?>]
	                </label>
				<br>
				<br>
				</div>
			   ...
			   <ul>
					...
					<li>
	                    ...
	                    <?php if($this->_var['mod'] != 'shopTask'){ ?>
	                      ...
	                      <li>
	                          <div class="name">需要好评晒图：</div>
	                          <div class="value short">
	                          	<input id="pinimage" type="checkbox" name="attrs[needimg]" value="1" <?php if($this->_var['temval']['attrs']['needimg'] == 1){ ?>checked="checked"<?php } ?>>
	                          </div>
	                          <div class="exp">需要接手晒图</div>
	                      </li>
						  <li>
...
<input type="hidden" name="point[sb]" value="<?php echo $this->_var['task_set']['cbxIsSB']; ?>">
<input type="hidden" name="point[qg]" value="<?php echo $this->_var['task_set']['Express1']; ?>">
<input type="hidden" name="point[qs]" value="<?php echo $this->_var['task_set']['Express2']; ?>">
<input type="hidden" name="point[sh]" value="<?php echo $this->_var['task_set']['cbxIsAudit']; ?>">
<input type="hidden" name="point[sj]" value="<?php echo $this->_var['task_set']['isMobile']; ?>">
<input type="hidden" name="point[wx]" value="<?php echo $this->_var['task_set']['cbxIsWX']; ?>">
<input type="hidden" name="point[ww]" value="<?php echo $this->_var['task_set']['cbxIsWW']; ?>">
<input type="hidden" name="point[qrsh]" value="<?php echo $this->_var['task_set']['cbxIsLHS']; ?>">
<input type="hidden" name="point[hp]" value="<?php echo $this->_var['task_set']['cbxIsMsg']; ?>">
<input type="hidden" name="point[gdsh]" value="<?php echo $this->_var['task_set']['cbxIsAddress']; ?>">
<input type="hidden" name="point[gwsc]" value="<?php echo $this->_var['task_set']['shopcoller']; ?>">
<input type="hidden" name="point[fx]" value="<?php echo $this->_var['task_set']['isShare']; ?>">
<input type="hidden" name="point[jt]" value="<?php echo $this->_var['task_set']['pinimage']; ?>">
<input type="hidden" name="point[js1]" value="<?php echo $this->_var['task_set']['fmaxmc1']; ?>">
<input type="hidden" name="point[js2]" value="<?php echo $this->_var['task_set']['fmaxmc2']; ?>">
<input type="hidden" name="point[js3]" value="<?php echo $this->_var['task_set']['fmaxmc3']; ?>">
<input type="hidden" name="point[js4]" value="<?php echo $this->_var['task_set']['fmaxmc4']; ?>">
<input type="hidden" name="point[stop1]" value="<?php echo $this->_var['task_set']['stopTime1']; ?>">
<input type="hidden" name="point[stop2]" value="<?php echo $this->_var['task_set']['stopTime2']; ?>">
<input type="hidden" name="point[stop3]" value="<?php echo $this->_var['task_set']['stopTime3']; ?>">
<input type="hidden" name="point[state3]" value="<?php echo $this->_var['task_set']['yanchi_state3']; ?>">
<input type="hidden" name="point[state24]" value="<?php echo $this->_var['task_set']['yanchi_state24']; ?>">
<input type="hidden" name="point[sm]" value="<?php echo $this->_var['task_set']['isReal']; ?>">
<input type="hidden" name="point[tjb]" value="<?php echo $this->_var['task_set']['cbxIsTaoG']; ?>">
<input type="hidden" name="point[ds]" value="<?php echo $this->_var['task_set']['cbxIsSetTime']; ?>">
<input type="hidden" name="point[gl]" value="<?php echo $this->_var['task_set']['cbxIsFMinGrade']; ?>">
<input type="hidden" name="point[gldj]" value="<?php echo $this->_var['task_set']['buyerJifen1']; ?>">
<input type="hidden" name="point[ll]" value="<?php echo $this->_var['task_set']['isViewEnd']; ?>">
