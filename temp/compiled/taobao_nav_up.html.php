...
<div class="tico menu">
	<a href="?mod=index" <?php if($this->_var['mod'] == 'index'){ ?>class="nov"<?php } ?> title="淘宝任务大厅">淘宝任务大厅</a>
	<a href="?mod=inTask" <?php if($this->_var['mod'] == 'inTask'){ ?>class="nov"<?php } ?> title="已接任务">已接任务</a>
	<a href="?mod=outTask" <?php if($this->_var['mod'] == 'outTask'){ ?>class="nov"<?php } ?> title="已发任务">已发任务</a>
	<a href="?mod=bindBuyer" <?php if($this->_var['mod'] == 'bindBuyer'){ ?>class="nov"<?php } ?> title="绑定买号">绑定买号</a>
