   	    ...
   	    <table id="insert-after" width="100%" border="0" cellspacing="0" cellpadding="0">
   	      <thead>
          	<tr>
	            ...
	            <td width="12%" align="center" valign="middle" class="tico rwdt_bt2"><span class="h-sort floatcenter" val="goodsPrice" onclick="getTasksa('getoutTask','goods_price')">任务价格</span></td>
	            <td width="18%" align="center" valign="middle" class="tico rwdt_bt2"><span class="h-sort floatcenter" val="timeEnter" style="width:88px;" onclick="getTasksa('getoutTask','ddlOKDay')">发布者要求</span></td>
	            <td width="12%" align="center" valign="middle" class="tico rwdt_bt2"><span class="h-sort floatcenter" val="maidian" onclick="getTasksa('getoutTask','txtMinMPrice')">悬赏刷点</span></td>
	            <td width="12%" align="center" valign="middle" class="tico rwdt_bt2"><span class="h-sort floatcenter" val="state" onclick="getTasksa('getoutTask','process')">任务状态</span></td>
	            <td width="1%" align="center" valign="middle" class="tico rwdt_bt2"></td>
	            <td width="50" align="center" valign="middle" class="tico rwdt_bt2"></td>
    ...
    <tr>
        <td width="180" class="yf_pd2">
            <span class="hico type<?php echo $this->_var['vals']['task_types']; ?> topt" style="width: 180px;">
				...
				<input type="hidden" name="task_id" value="<?php echo $this->_var['vals']['id']; ?>" class="task_id">
            </span>
            <p class="cle"></p>
            <span class="block">
                发布时间:<?php echo $this->_var['vals']['add_time']; ?>
            </span>
            <span class="rwdt_xbh0">掌柜名:<a target="_blank" href="info.php?act=info&uname=<?php echo $this->_var['vals']['add_user']; ?>"><?php echo $this->_var['vals']['add_user']; ?></a></span>
        </td>
        ...
        <td width="120" align="center" class="yf_pd">
            <strong class="orange">
                ...
                <?php if($this->_var['vals']['process'] == 0){ ?>等待接手方对商品付款<?php } ?>
				...
				<?php if($this->_var['vals']['process'] == 4){ ?>任务完成<b style="font-size: 12px; font-weight: normal; float: left;">时间:<?php echo $this->_var['vals']['get_time']; ?></b><?php } ?>
				<?php if($this->_var['vals']['process'] == 5){ ?>此任务被暂停<?php } ?>
        ...
        <td width="240" align="right" class="yf_pd2" valign="top" style="padding:0px;">
            <div style="height:30px; position:relative; top:5px;left: 20px;">
				...
				<?php if($this->_var['vals']['process'] == 0 && $this->_var['vals']['attrs']['cbxIsAudit'] == 1 && $this->_var['vals']['get_user'] > 0 && $this->_var['vals']['finish']['cbxIsAudit'] != 1){ ?><a href="javascript:shenhe(<?php echo $this->_var['vals']['id']; ?>);" class="aico abtn11" copy-field="goodsUrl">&nbsp;</a>
				<a href="javascript:news(<?php echo $this->_var['vals']['id']; ?>);" class="aico abtn13" copy-field="goodsUrl">&nbsp;</a><?php } ?>
				
                <?php if($this->_var['vals']['process'] == 0 && $this->_var['vals']['get_user'] == 0){ ?><a href="javascript:getTaobaourl(<?php echo $this->_var['vals']['id']; ?>);" class="aico abtn3" copy-field="goodsUrl">&nbsp;</a><?php } ?>
			
				<?php if($this->_var['vals']['process'] == 0 && $this->_var['vals']['get_user'] > 0){ ?>
				<?php if(( $this->_var['vals']['attrs']['cbxIsAudit'] == 1 && $this->_var['vals']['finish']['cbxIsAudit'] == 1 ) || $this->_var['vals']['attrs']['cbxIsAudit'] == 0){ ?><a href="javascript:addtime(<?php echo $this->_var['vals']['id']; ?>);" class="aico abtn12" copy-field="goodsUrl">&nbsp;</a><?php } ?><?php } ?>

				
				<?php if($this->_var['vals']['process'] == 1 && $this->_var['vals']['ddlOKDay'] > 1 && $this->_var['vals']['express'] == 0){ ?><a href="javascript:gmdh(<?php echo $this->_var['vals']['id']; ?>,'<?php echo $this->_var['vals']['nickname']; ?>');" class="aico bunufh " copy-field="goodsUrl" style="height: 36px;background: url(themes/default/images/taobao/yfrw_iconew.png) no-repeat 0 -2927px;width: 120px;  ">&nbsp;</a><?php } ?>

				<?php if($this->_var['vals']['process'] == 1){ ?><a href="javascript:yifa(<?php echo $this->_var['vals']['id']; ?>,'<?php echo $this->_var['vals']['buyno']; ?>');" class="aico abtn15" copy-field="goodsUrl">&nbsp;</a><?php } ?>

				<?php if($this->_var['vals']['process'] == 2){ ?><a href="javascript:;" class="aico abtn21" copy-field="goodsUrl">&nbsp;</a><?php } ?>

				<?php if($this->_var['vals']['process'] == 3){ ?><a href="javascript:queren(<?php echo $this->_var['vals']['id']; ?>);" class="aico abtn10" copy-field="goodsUrl">&nbsp;</a><?php } ?>
				...
				<?php if($this->_var['vals']['process'] == 4 && $this->_var['vals']['ddlOKDay'] > 1 && $this->_var['vals']['appex'] == ''){ ?><a href="javascript:didan(<?php echo $this->_var['vals']['id']; ?>);" class="aico ddsq0">&nbsp;</a><?php } ?>
			

				<?php if($this->_var['vals']['process'] == 5){ ?><a href="javascript:huifu(<?php echo $this->_var['vals']['id']; ?>);" class="aico abtn9" copy-field="goodsUrl">&nbsp;</a><?php } ?>
				<?php } ?>
            </div>
			...
			<?php if($this->_var['vals']['process'] == 0 && $this->_var['vals']['get_user'] > 0){ ?>
				<?php if(( $this->_var['vals']['attrs']['cbxIsAudit'] == 0 || ( $this->_var['vals']['attrs']['cbxIsAudit'] == 1 && $this->_var['vals']['finish']['cbxIsAudit'] == 1 ) )){ ?>
				<p style="clear:both; line-height:30px;height:30px;">付款剩余时间：<strong class="green time" time="<?php echo $this->_var['vals']['time']; ?>"></strong></p>
				<?php } ?>
			<?php } ?>
			...
			<?php if($this->_var['vals']['process'] == 2 && $this->_var['vals']['ddlOKDay'] > 0){ ?><p style="clear:both; line-height:30px;height:30px;">自动收货倒计时：<strong class="green time" time="<?php echo $this->_var['vals']['time']; ?>"></strong></p><?php } ?>
            <p class="task-border">
				<?php if($this->_var['vals']['get_user'] > 0){ ?>
				...
				<?php } ?>
				<?php if($this->_var['vals']['get_user'] == 0){ ?>
				<a href="javascript:zuijia(<?php echo $this->_var['vals']['id']; ?>);" title="追加刷点" class="yf_zmd">追加刷点</a>
				<?php if($this->_var['vals']['process'] == 0){ ?><a href="javascript:stop(<?php echo $this->_var['vals']['id']; ?>);" title="暂停任务" class="yf_zt">暂停</a><?php } ?>&nbsp;
				<?php } ?>
				<?php if($this->_var['vals']['process'] == 0 || $this->_var['vals']['process'] == 5){ ?>
				<a href="javascript:cancel(<?php echo $this->_var['vals']['id']; ?>);" title="取消发布" class="yf_qx">取消</a><?php } ?>

				<?php if($this->_var['vals']['process'] == 3 && strlen ( $this->_var['vals']['attrs']['pinimage'] ) > 2 && $this->_var['vals']['attrs']['haoping'] == ''){ ?>
				<a href="javascript:pingtu(<?php echo $this->_var['vals']['id']; ?>);" title="评图" class="yf_qx">评图</a><?php } ?>
    ...
    <tr>
        <td colspan="9" valign="middle" class="yfrw_listxia">
            <ul>
                ...
                <li>
                    <span class="f-left" style="width: 500px;;height: 20px;">
                        <span class="aico"></span><?php if($this->_var['vals']['username'] == ''){ ?></a>接手方:<a href="javascript:;" class="blue nicknames" val="qinsijiong">暂无</a><?php }else{ ?>接手方:<a href="javascript:;" class="blue nicknames" val="qinsijiong"><?php echo $this->_var['vals']['username']; ?></a><?php } ?>&nbsp;&nbsp;<?php if($this->_var['vals']['addsss'] == ''){ ?><a href="javascript:;">地址:用户未填写</a><?php }else{ ?><a href="javascript:;">地址:<?php echo $this->_var['vals']['addsss']; ?></a><?php } ?>
						
                    </span>
                    <span class="f-left"><span class="aico wangwang"></span>
                        <span>
                            采用买号:<a href="info.php?act=info&uname=<?php echo $this->_var['vals']['buyno']; ?>" class="blue" target="_blank" title="查看买号信息"><?php echo $this->_var['vals']['buyno']; ?></a>
