...
<script type="text/javascript" src="themes/default/js/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="themes/default/js/ueditor/ueditor.all.js"></script>
<script type="text/javascript">
$(function(){
	getweixininTask(),getinTaskb('operat');
...
<div id="moveContent"><div><div class="rwdt_xx">
	...
	<ul class="yfrw_sub">
		...
		<li style="z-index:11">
			<a href="javascript:getweixininTask(),getinTaskb('operat');" class="sbico active operat"></a>
		...
		<li style="z-index:10">
			<a href="javascript:getweixinfinish({process:'2'}),getinTaskb('complete');" class="sbico complete"></a>
		...
		<!-- <li style="z-index:9">
			<a href="javascript:getinTask({process:'3'}),getinTaskb('all-task')" class="sbico all-task"></a>
	...
	<!-- <div class="rwdt_sort">
		...
		<a href="javascript:getinTask({'num':0});" class="def-a" val="4">待付款(<span class="orange"><?php echo $this->_var['fukuan']['num']; ?></span>)</a>
		
		<a href="javascript:getinTask({'num':1});" class="def-a" val="5">待发货(<span class="orange"><?php echo $this->_var['fahuo']['num']; ?></span>)</a>
		
		<a href="javascript:getinTask({'num':2});" class="def-a" val="6">待收货(<span class="orange"><?php echo $this->_var['shouhuo']['num']; ?></span>)</a>
		
		<a href="javascript:getinTask({'num':3});" class="def-a" val="7">待放款(<span class="orange"><?php echo $this->_var['fangkuan']['num']; ?></span>)</a>
...
<input type="hidden" name="process" value="1">
	<div class="task_search">
		...
		<a href="javascript:;" class="search" onclick="getTasksearch('getinTask');">搜索</a>
	</div>
</div>
<div class="cle"></div>
<div id="taskList">
