...
$(function(){
	getweixinoutTask(),getinTaskb('operat');
...
<div id="moveContent"><div><div class="rwdt_xx">
	...
	<ul class="yfrw_sub">
		...
		<li style="z-index:11">
			<a href="javascript:getweixinoutTask(),getinTaskb('operat');" class="sbico active operat"></a>
		...
		<!-- <li style="z-index:10">
			<a href="javascript:getweixinoutTask({process:'4'}),getinTaskb('pause');" class="sbico pause" val="1"></a>
		...
		<li style="z-index:9">
			<a href="javascript:getweixinoutfinish({process:'2'}),getinTaskb('complete');" class="sbico complete"></a>
		...
		<!-- <li style="z-index:9">
			<a href="javascript:getweixinoutTask({process:'3'}),getinTaskb('all-task')" class="sbico all-task"></a>
