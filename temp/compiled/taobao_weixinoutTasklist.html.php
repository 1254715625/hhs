        ...
        <div class="xgguod" style="width:90%;">
            <ul>
				...
				<?php if($this->_var['vals']['process'] == 0){ ?>
					<a href="javascript:void(0)" onclick="qiang('<?php echo $this->_var['vals']['id']; ?>');" class="freeof" style="background-color: #FF6E02;color: white;">
						待接手
					</a>
				<?php }else{ ?>
                      <div style="width: 150px;margin: 0px auto;">
                        <a href="javascript:void(0)" <?php if($this->_var['vals']['process'] == 2 || $this->_var['vals']['process'] == 1){ ?>onclick="weixinqueren('<?php echo $this->_var['vals']['id']; ?>')"<?php } ?> class="freeof" style="background-color: #FF6E02;color: white;display:inline-block;width:64px; ">
								<?php if($this->_var['vals']['process'] == 2 || $this->_var['vals']['process'] == 1){ ?>确认完成<?php } ?>
                        </a>
                        <a href="javascript:void(0)" ids="<?php echo $this->_var['vals']['id']; ?>" class="freeof" style="background-color: #CCC;color: white;width:64px;display:inline-block;">
								终止
                        </a>
                       </div>
                <?php } ?>
