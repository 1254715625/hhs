...
<div id="wrap">
	<div class="primg1">
		<div class="direct">
			...
			<!--<span id="copy" link="http://hhs.lianmon.com/?reg=<?php echo $this->_var['code']; ?>" class="">开始赚钱</span>-->
			<span id="copy" link="http://<?php echo $_SERVER['HTTP_HOST']  ?>/?reg=<?php echo $this->_var['code']; ?>" class="">开始赚钱</span>
			...
			<ul class="line" style="float: left;height: 25px;overflow: hidden;width: 200px;margin-top: 2px;position: absolute;bottom: -20px;right: 158px;color: white;">
				...
				<li style="margin-top: 0px;"><?php echo $this->_var['v']['user_name']; ?>获得推广用户购卡提成3.00元</li>
				<?php } ?>
			</ul>
		</div>
	</div>
	...
	<div class="primg3">
		<div class="centz">
			...
			<a class="url3" num="<?php echo $this->_var['uinfo']['rank_points']; ?>" href="javascript:;" target="_blank">活跃奖金</a>
		</div>
	</div>
...
<script type="text/javascript" src="themes/default/js/jquery.zclip.min.js"></script>
<script>
$(function(){
		function copyUrl(ele){
			$(ele).zclip({ 
				path: "themes/default/js/ZeroClipboard.swf", 
				copy: function(){ 
					return $("#copy").attr("link");; 
	  　　　 　 },
				afterCopy:function(){
