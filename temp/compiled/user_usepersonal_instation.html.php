	...
	<form id="jForm" method="post" action="">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody><tr>
                ...
                <?php if($this->_var['instation'])foreach($this->_var['instation'] as $this->_var['k'] => $this->_var['v']){ ?>
                <tr>
                    <td height="35" bgcolor="#eff6fd">&nbsp;</td>
                    <td valign="middle" bgcolor="#eff6fd" align="left" colspan="3"><span class="znx_sj"><?php echo $this->_var['k']; ?></span></td>
                    <td bgcolor="#eff6fd">&nbsp;</td>
                </tr>
				<?php if($this->_var['v'])foreach($this->_var['v'] as $this->_var['key'] => $this->_var['val']){ ?>
    	  		<tr>
                    <td height="35">&nbsp;</td>
                    <td width="63%" valign="middle" align="left">&nbsp; <?php echo $this->_var['key']; ?></td>
                    <td width="20%" valign="middle" align="center">
                    	<input type="checkbox" value="1" class="website" name="<?php echo $this->_var['val']; ?>[website]" <?php if($this->_var['uinfo'] [ 'mess_set' ] [ $this->_var['val'] ] [ 'website' ] == 1){ ?>checked<?php } ?>>
                    </td>
                    <td width="15%" valign="middle" align="center">

                    	<span class="chengse2">
                    		<input type="checkbox" value="1" class="mobile" name="<?php echo $this->_var['val']; ?>[mobile]" <?php if($this->_var['uinfo'] [ 'mess_set' ] [ $this->_var['val'] ] [ 'mobile' ] == 1){ ?>checked<?php } ?>>
                    	</span>
                    </td>
            		<td>&nbsp;</td>
         		</tr>
