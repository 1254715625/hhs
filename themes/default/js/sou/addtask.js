$(function(){
	...
	$("#goodsurl").blur(function(){
		...
		$.get("sou.php?mod=getgoodsprice&url="+url,function(data,status){
			if(data=='notfind'){
	...
	$(".uploadImgs").wrap("<form class='myupload' action='sou.php?mod=photourl' method='post' enctype='multipart/form-data'></form>");
